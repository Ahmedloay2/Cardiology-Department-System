...
namespace Caridology_Department_System.Migrations
{
    ...
    [Migration("20250705114409_fixing reportmodel")]
    partial class fixingreportmodel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caridology_Department_System.Models.ReportModel", b =>
                {
                    b.HasOne("Caridology_Department_System.Models.AppointmentModel", "Appointment")
                        .WithMany()
                        .HasForeignKey("AppointmentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Caridology_Department_System.Models.DoctorModel", null)
                        .WithMany("AuthoredReports")
                        .HasForeignKey("DoctorModelID");

                    b.HasOne("Caridology_Department_System.Models.PatientModel", null)
                        .WithMany("Reports")
